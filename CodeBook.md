...
Then, using the dplyr package, the data was grouped by subject and activity, and the mean was taken for each feature.

The end result is a tidy data set with 180 rows and 81 columns.
